...
class MatplotlibWidget(QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("Mitre Results Analyzer")
    ...
    def update_graph(self):
        ...
        self.MplWidget.canvas.axes.clear()
        #self.MplWidget.canvas.bar(missed_detections_by_company, height=100)
        self.MplWidget.canvas.axes.plot(missed_detections_by_company)
        self.MplWidget.canvas.draw()
